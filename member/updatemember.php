...
function editLocation(addressType) {
    ...
    // Get current values from hidden form fields
    ...
    // Initialize Select2 and set values when modal is shown
    setTimeout(function() {
        initializeModalSelect2();
        // Set field values from current record
        $('#modalVillage').val(village).trigger('change');
        $('#modalTaluk').val(taluk).trigger('change');
        $('#modalDistrict').val(district).trigger('change');
        $('#modalState').val(state).trigger('change');
        $('#modalCountry').val(country).trigger('change');
        $('#modalPincode').val(pincode).trigger('change');
    }, 100);
}
